<template>
    <div>
        ...
        <router-link v-if="$route.params.cam_id === 'left'" :to="{ path: '/pod/' + $route.params.pod_id +'/cam/' + $route.params.cam_id + '/settings' }"><i class="fa fa-cog" aria-hidden="true"></i></router-link>
